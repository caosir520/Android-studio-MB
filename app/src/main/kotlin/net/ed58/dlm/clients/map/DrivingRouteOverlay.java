package net.ed58.dlm.clients.map;
...
public class DrivingRouteOverlay extends RouteOverlay {
    ...
    private int getcolor(String status) {
        ...
        return Color.parseColor("#f08300");
    }
                ...
                if (latLonPoint != null) {
                    Marker throughMarker = mAMap
                            .addMarker((new MarkerOptions())
                                    ...
                                    .title("\u9014\u7ECF\u70B9"));
//                    throughMarker.showInfoWindow();
                    throughPointMarkerList.add(throughMarker);
                }
            }
        }
    }

    public List<Marker> getThroughPointMarkerList() {
        return throughPointMarkerList;
    }

    public void setThroughPointMarkerList(List<Marker> throughPointMarkerList) {
        this.throughPointMarkerList = throughPointMarkerList;
    }

    private BitmapDescriptor getThroughPointBitDes() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.icon_location_fetch);
