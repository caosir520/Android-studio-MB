...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setImageIcon(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.displayIcon(mContext,view,url);
        return this;
    }
    ...
    public ViewHolderHelper setVisibleNoGone(int viewId, boolean visible) {
        View view = getView(viewId);
